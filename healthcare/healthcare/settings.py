...
SECRET_KEY = 'django-insecure-^j%zxxew$lx)3zevk4#pzn%b-h8dwa#r8fw%r!8t(8zphwn9)7'
...
LOGIN_URL = '/login/'  # Or the path to your login page
LOGIN_REDIRECT_URL = '/'  # After login, redirect to the home page or any other page
